...
// Inject styles into document (SSR-safe — only on client)
if (typeof document !== "undefined" && !document.getElementById("vela-ai-prompt-styles")) {
  const styleSheet = document.createElement("style");
  styleSheet.id = "vela-ai-prompt-styles";
