...
/**
 * App Store + Google Play indirme rozetleri (footer ile birebir stil).
 * Download sayfası ve footer'da paylaşılır.
 */
...
export function AppStoreBadge() {
  return (
    <Link
      href="/download"
      className="flex h-14 w-[180px] items-center gap-3 rounded-xl bg-black px-4 ring-1 ring-white/15 transition hover:bg-black/80"
    >
...
export function GooglePlayBadge() {
  return (
    ...
    >
      ...
      <span className="text-left leading-tight">
        <span className="block text-[9px] text-white/60">BURADAN İNDİR</span>
