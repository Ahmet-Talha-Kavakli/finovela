...
const url=process.argv[2],out=process.argv[3],sy=Number(process.argv[4]||0);
...
await p.goto(url,{waitUntil:"networkidle0",timeout:60000}); await new Promise(r=>setTimeout(r,2200));
if(sy) await p.evaluate(y=>window.scrollTo(0,y),sy);
