...
await p.evaluate(()=>{const t=[...document.querySelectorAll('span')].find(e=>/AI NATIVE/.test(e.textContent||'')); if(t)t.scrollIntoView({block:'center'});});
await new Promise(r=>setTimeout(r,900)); await p.screenshot({path:"/tmp/native-macbook.png"});
