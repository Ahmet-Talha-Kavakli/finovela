...
await p.goto("http://localhost:3000/",{waitUntil:"networkidle0",timeout:60000}); await new Promise(r=>setTimeout(r,3500));
await p.screenshot({path:"/tmp/nav-signedout.png",clip:{x:760,y:0,width:680,height:110}});
console.log("done");
await b.close();
