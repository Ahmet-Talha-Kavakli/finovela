...
await p.goto("http://localhost:3000/disclaimer",{waitUntil:"networkidle0",timeout:60000}); await new Promise(r=>setTimeout(r,2500));
await p.screenshot({path:"/tmp/legal-disclaimer.png"});
// footer: scroll to bottom
await p.evaluate(()=>window.scrollTo(0,document.body.scrollHeight));
await new Promise(r=>setTimeout(r,1200));
await p.screenshot({path:"/tmp/legal-footer.png"});
