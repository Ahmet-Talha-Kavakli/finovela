...
await p.goto("http://localhost:3000/dashboard/stock/AAPL",{waitUntil:"networkidle0",timeout:60000}); await new Promise(r=>setTimeout(r,2000));
...
await p.screenshot({path:"/tmp/pc-fs.png"});
